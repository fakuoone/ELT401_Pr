...
/* Hauptprogramm */
int main(void) {
	/* Definiton von privaten Variablen */
	int operand_1, operand_2;
	operand_1 = eingabe_operand1();
	operand_2 = eingabe_operand2();
	auswahl_rechenart_mit_ausgabe(operand_1, operand_2);
	return 0;
}
